...
export function InterventionPdf(props) {
  const [dureeIntervention, setDureeIntervention] = useState("");
  console.log("pdf props", props.data);
  const { data } = props;
  useEffect(() => {
    msToTime(data.dateDebutIntervention, data.dateFinIntervention);
  }, []);
          ...
          <View style={styles.movieContainer}>
            ...
            >
              ...
              >
                <Text
                  style={{ fontSize: 12 }}
                >{`DATE HEURE DEBUT : ${data.dateDebutIntervention}`}</Text>
                <Text
                  style={{ fontSize: 12 }}
                >{`DATE HEURE FIN : ${data.dateFinIntervention}`}</Text>
              </View>
              <View
                style={{
                  height: "100%",
            ...
            >
              <Text>{"REPARATION / INTERVENTION  EFFECTUEE :"}</Text>
            ...
            >
              <Text>{"PIECES OU  ELEMENTS REMPLACES :"}</Text>
              <View
                style={{
                  padding: 4,
                  // height: "100%",
              ...
              >
                ...
                {data.piecesRemplace.map((piece, index) => (
                  <View
                    style={{
                      width: "50%",
                      flexDirection: "row",
            ...
            >
              <Text>{"COMPTE RENDU DE L'INTERVENTION:"}</Text>
              <View
                style={{
                  padding: 4,
                  // height: "100%",
              ...
              >
                <Text style={{ fontSize: 12 }}> {data.cpteRendu}</Text>
              </View>
            </View>
            <View>
              <View

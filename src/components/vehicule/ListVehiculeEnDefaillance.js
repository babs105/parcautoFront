...
function ListVehiculeEnDefaillance() {
  ...
  return (
    <div className="listDiagContainer">
      ...
      <div className="tableContainer">
        <h1 className="tableTitle">Vehicules en defaillance</h1>
...
export default ListVehiculeEnDefaillance;

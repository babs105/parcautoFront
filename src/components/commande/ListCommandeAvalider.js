  ...
  return (
    <div className="listDiagContainer">
      ...
      <div className="tableContainer">
        <h1 className="tableTitle">Les Commandes à Valider </h1>
                  ...
                  commande.statut === "avalider" && (
                    <tr key={index} className="active-row">
                      ...
                      <td className="actionTable">
                        ...
                        <Link
                          to={{
                            pathname: "/commande/valider-commande",
                            state: commande,
                          }}
                        >
                          <button className="buttonActionTab">Valider</button>
                        </Link>
...
export default ListCommandeAvalider;
